...
- [Weather Bond Rotator Workflow](../../workflows/weather-bond-rotator/README.md) - Rotate exact Polymarket weather close-to-bond watchers and emit gated dry-run trade intents.
