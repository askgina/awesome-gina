...
- Setup guide reference: skills/official/sandbox/workflows/SKILL.md
- Implementation details: skills/official/sandbox/workflows/references/polymarket-patterns.md
